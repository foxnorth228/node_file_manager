import { checkAccess, checkArgsNumber, executeCommandFunction, checkParentDirAccess } from "../supportiveFileFuncs.js";
...
async function upDir(processedInput) {
    await checkParentDirAccess(getSetting("location"));
